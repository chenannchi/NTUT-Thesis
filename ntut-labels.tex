...
\newcommand\cTitle{基於案例式學習與動態計畫修復之 API 任務大型語言模型代理人自我修正機制研究}

% 我的姓名（中文）
% My Name（Chinese）
\newcommand\myCname{陳安琪}

% 指導教授的姓名 (中文)，使用頓號隔開 
% Advisor (Chinese), use “、” to separate names
\newcommand\advisorCname{劉建宏 博士}
...
\newcommand\eTitle{A Self-Correction Mechanism for LLM Agents in API Tasks Using Case-Based Learning and Dynamic Plan Repair}

% 我的姓名（英文）
% My Name（English）
\newcommand\myEname{Chen, An-Chi}
...
\newcommand\advisorEname{Dr. Liu Chien-Hung} 
